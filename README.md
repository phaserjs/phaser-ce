...
The [current Phaser CE release is 2.13.0](https://github.com/photonstorm/phaser-ce/releases/tag/v2.13.0).
...
```html
<script src="//cdn.jsdelivr.net/npm/phaser-ce@2.13.0/build/phaser.js"></script>
```

or the minified version:

```html
<script src="//cdn.jsdelivr.net/npm/phaser-ce@2.13.0"></script>
```

[Custom builds](https://cdn.jsdelivr.net/npm/phaser-ce@2.13.0/build/custom/) are available too.
...
[get-js]: https://github.com/photonstorm/phaser-ce/releases/download/v2.13.0/phaser.js
[get-minjs]: https://github.com/photonstorm/phaser-ce/releases/download/v2.13.0/phaser.min.js
[get-zip]: https://github.com/photonstorm/phaser-ce/archive/v2.13.0.zip
[get-tgz]: https://github.com/photonstorm/phaser-ce/archive/v2.13.0.tar.gz
