...
*/
Phaser.StripShader = function(gl)
{
    /**
     * @property _UID
     * @type Number
...
Phaser.StripShader.prototype.constructor = Phaser.StripShader;
...
* @method init
*/
Phaser.StripShader.prototype.init = function()
{
    var gl = this.gl;
...
* @method destroy
*/
Phaser.StripShader.prototype.destroy = function()
{
